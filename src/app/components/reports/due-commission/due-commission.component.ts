...
@Component({
  selector: 'app-due-commission',
  templateUrl: './due-commission.component.html',
  styleUrls: ['./due-commission.component.scss'],
  providers:[DatePipe]
})
export class DueCommissionComponent {
  ...
  SubmitForm(){
    ...
    console.log(Model);
    this._ReportsService.DueCommission(Model).subscribe((data:any)=>{
      this.loading = false;
      let blob:Blob = data.body as Blob
      this.FileName= 'DueCommissionReport.xlsx'
