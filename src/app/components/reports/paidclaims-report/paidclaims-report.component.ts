...
@Component({
  selector: 'app-paidclaims-report',
  templateUrl: './paidclaims-report.component.html',
  styleUrls: ['./paidclaims-report.component.scss'],
  providers : [DatePipe]
})
export class PaidclaimsReportComponent {
  ...
  Search(){
    ...
    console.log(Model);
    this._ReportsService.PaidClaim(Model).subscribe((data:any)=>{
      this.loading = false;
      let blob:Blob = data.body as Blob
      this.FileName= 'PaidClaimReport.xlsx'
