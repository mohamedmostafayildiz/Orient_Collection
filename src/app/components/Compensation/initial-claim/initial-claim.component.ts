...
@Component({
  selector: 'app-initial-claim',
  templateUrl: './initial-claim.component.html',
  styleUrls: ['./initial-claim.component.scss'],
  providers:[DatePipe]
})
export class InitialClaimComponent {
  ...
  Search(){
    ...
    this._Router.navigate(['/InitialClaim'],{
  ...
  ngOnInit(){
    ...
    this._SharedService.changeData(true,'Claim','InitialClaim',true,false);
